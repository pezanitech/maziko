...
const styles = {
    ...
    pattern: clsx`absolute inset-0 [mask-image:radial-gradient(100%_100%_at_top_center,black,transparent)] opacity-40`,
    glow: clsx`text-accent animate-pulse`,
}
        ...
        <div className={cn(styles.base, className)}>
            <div
                className={cn(
                    styles.pattern,
                    maskPosition === "center" &&
                        "[mask-image:radial-gradient(100%_100%_at_center,black,transparent)]",
                    maskPosition === "bottom" &&
                        "[mask-image:radial-gradient(100%_100%_at_bottom_center,black,transparent)]",
                )}
