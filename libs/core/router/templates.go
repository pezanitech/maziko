...
// TODO: CREATE A META LIBRARY TO ALLOW INJECTION OF DYNAMIC META TAGS
...
<html lang="en">
	<head>
        ...
        <meta
            name="description"
            content="A modern full-stack web framework designed for performance, developer experience, and scalability"
        />
        ...
        <meta
            property="og:url"
            content="https://maziko.pezani.com/"
        />
        <meta
            property="og:title"
            content="Maziko"
        ...
        <meta
            property="og:image"
            content="https://maziko.pezani.com/images/og-image.jpg"
        />
        <meta
